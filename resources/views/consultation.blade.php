    ...
    <div class="container">
        <div data-w-id="78795549-880c-569d-71f1-96f409591285" style="opacity:0" class="login-block">
            ...
            <div class="form-login-wrapper w-form">
                <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form-block" data-wf-page-id="67e5136bf4d6e968caa5072f" data-wf-element-id="a2ab6eb9-5264-82c6-6692-e8862d162daa">
                    <div class="rows-form-block">
                        <div class="flex-vertical gap-6"><label for="Name-consultation-page" class="input-text">Как к вам обращаться?</label><input class="text-field w-input" maxlength="256" name="Name-consultation-page" data-name="Name-consultation-page" placeholder="Введите имя" type="text" id="Name-consultation-page" required=""></div>
                            ...
                            <div data-hover="false" data-delay="0" data-w-id="36d58a68-3920-b344-64e6-188e4e4332b7" class="dropdown-calendar w-dropdown">
                                <div class="dropdown-toggle-calendar w-dropdown-toggle">
                                    <div class="flex-horizontal gap-8">
                                        ...
                                        <div class="standart-text">Дата</div>
                                    </div>
                                ...
                                <nav class="dropdown-list calendar w-dropdown-list">
                                    <a href="#" class="dropdown-link-time w-inline-block">
                                        <div>Добавить календарь</div>
                                    </a>
                                </nav>
                            </div>
                            <div data-hover="false" data-delay="0" data-w-id="bdd0a6ec-53da-f7fb-7c29-2bf6e2c1398d" class="dropdown-calendar w-dropdown">
                                <div class="dropdown-toggle-time w-dropdown-toggle">
                                    <div class="flex-horizontal gap-8">
                                        ...
                                        <div class="standart-text">Время</div>
                                    </div>
                                    <div class="icon-dropdown w-embed"><svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5 7.5L10 12.5L15 7.5" stroke="#717680" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg></div>
        ...
        <div class="popup-container">
            <div class="popup-form-grid">
                ...
                <div class="popup-form-block w-form">
                    <form id="wf-form-Email-form" name="wf-form-Email-form" data-name="Email form" method="get" class="form-block" data-wf-page-id="67e5136bf4d6e968caa5072f" data-wf-element-id="4ee6f207-47d2-888e-2b36-068482ba3c23">
