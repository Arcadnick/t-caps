    ...
    <section data-w-id="45997f92-ae36-e406-96bb-e1c177f3833c" class="hero-section more-top-padding-mobi">
        ...
        <div class="hero-container">
            <div data-w-id="696c1e16-ba6b-4170-72cf-81fcfc352401" style="opacity:0" class="h1-block">
                <h1><span class="focus-blue">Создавайте</span> AI-Капсулы<br>и <span class="focus-blue">зарабатывайте</span> на их внедрении</h1>
                <div class="subheader">Мы разрабатываем AI-Капсулы – готовые решения для бизнеса. Если у вас есть экспертиза в AI, автоматизации или разработке, вы можете создать свою AI-Капсулу и получать процент с её продаж и внедрения либо выбрать фиксированное вознаграждение за её разработку.</div>
            </div>
            ...
            <div class="hero-shapes-wrapper"><img src="{{ asset('images/caps-7.png') }}" loading="lazy" alt="" class="hero-img"><img src="{{ asset('images/caps-small-3.png') }}" loading="lazy" alt="" class="hero-img small"><img src="{{ asset('images/caps-small-2.png') }}" loading="lazy" alt="" class="hero-img left-aling"><img src="{{ asset('images/caps-small-1.png') }}" loading="lazy" alt="" class="hero-img small _2-v"></div>
        </div>
    </section>
    <section class="section border-top">
        <div class="container">
            <div data-w-id="663b2468-0223-0ab9-df01-307c6705376d" style="opacity:0" class="h2-block">
                <h2 class="center-aling">Какие AI-Капсулы можно разработать?</h2>
                <div class="subheader">Вы можете выбрать капсулу из списка или предложить свою идею</div>
            </div>
            <div class="w-layout-grid choices-grid">
                <div data-w-id="b3f7c7a4-1f99-cc8d-1e2e-8aea3a4c26b0" style="opacity:0" class="choices-item">
                    <div class="h3-block">
                        <h3>AI-Капсула для автоматического расчёта KPI сотрудников</h3>
                    </div>
                    <div class="badge-base">
                        <div>Ищем разработчика</div>
                    </div>
                    <div class="text-block">
                        <p class="cadet-blue-font-color">AI анализирует показатели сотрудников и автоматически рассчитывает KPI, формируя отчёты для руководителя</p>
                    </div>
                </div>
                <div data-w-id="bbe1d9af-3f21-05bf-985a-add174acb9cf" style="opacity:0" class="choices-item">
                    <div class="h3-block">
                        <h3 class="min-height">AI-Капсула для автоматического расчёта KPI сотрудников</h3>
                    </div>
                    <div class="badge-base">
                        <div>Ищем разработчика</div>
                    </div>
    ...
    <section class="section border-top">
        <div class="container">
            <div data-w-id="04c40f12-4696-974c-564e-29403cdc9359" style="opacity:0" class="h2-block">
                <h2 class="center-aling">Варианты оплаты</h2>
            ...
            <div data-w-id="263344ba-d287-a0db-15e8-93f5c1ad481a" style="opacity:0" class="wrapper-btn">
                <a href="#" class="blue-button popap-show w-inline-block">
                    <div>Подать заявку на разработку</div>
                </a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="w-layout-grid grid-how-work">
                ...
                <div data-w-id="5231aef4-b560-be81-52cb-e5752cf44457" style="opacity:0" class="stages-item">
                    ...
                    <div class="text-block margin-auto">
                        <p class="more-height">Получаете процент с внедрений или фиксированное вознаграждение</p>
                    </div>
                </div>
            </div>
        ...
        <div class="nav-container-col">
            <nav role="navigation" class="nav-menu w-nav-menu">
                <div class="nav-menu-block">
                    ...
                    <a href="{{ route('partners') }}" aria-current="page" class="nav-link-block w-inline-block w--current">
